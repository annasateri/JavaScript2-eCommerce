...
<div class="container pt-5">
  <div class="mt-0">
    <div class="row">
      <img class="card-img-top aboutUsImg1" :src="aboutUsImg1" href="#">
    </div>
  </div>
  ...
  <div class="text-center mt-5">
    <img class="aboutUsImg card-img-top" :src="aboutUs" alt="Card image cap">
...
export default {
  data() {
    return {
      aboutUs: require('../assets/images/imgFrontpage/aboutUs.png'),
      aboutUsImg1: require('../assets/images/imgFrontpage/aboutUsImg1.png')
    }
  }
}
